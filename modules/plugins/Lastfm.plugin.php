...
class AmpacheLastfm { 
	...
	function install() { 
		...
		$sql = "INSERT INTO preferences (`name`,`value`,`description`,`level`,`type`,`catagory`) " . 
			"VALUES ('lastfm_host',' ','Last.FM Host','25','string','internal')";
		$db_results = mysql_query($sql,dbh());

		$sql = "INSERT INTO preferences (`name`,`value`,`description`,`level`,`type`,`catagory`) " . 
			"VALUES ('lastfm_url',' ','Last.FM URL','25','string','internal')";
		$db_results = mysql_query($sql,dbh());

		$sql = "INSERT INTO preferences (`name`,`value`,`description`,`level`,`type`,`catagory`) " . 
			"VALUES ('lastfm_port',' ','Last.FM Port','25','string','internal')";
		$db_results = mysql_query($sql,dbh());

		$sql = "INSERT INTO preferences (`name`,`value`,`description`,`level`,`type`,`catagory`) " . 
			"VALUES ('lastfm_challenge',' ','Last.FM Response','25','string','internal')";
		$db_results = mysql_query($sql,dbh());
	...
	function uninstall() { 
		...
		$sql = "DELETE FROM preferences WHERE name='lastfm_pass' OR name='lastfm_user' OR name='lastfm_port' " .
			"OR name='lastfm_url' OR name='lastfm_host' OR name='lastfm_challenge'"; 
		$db_results = mysql_query($sql,dbh());
